    ...
    return (
        <div class="relative">
            <button 
                ...
                class="flex items-center justify-center p-2 text-black hover:bg-white/10 dark:text-white dark:hover:bg-black/10 rounded-lg transition-colors cursor-pointer"
