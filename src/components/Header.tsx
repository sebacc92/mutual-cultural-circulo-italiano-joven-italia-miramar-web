        ...
        <div class="container mx-auto px-4 h-14 flex justify-between items-center">
          <div class="flex items-center gap-6">
            <a
              ...
              class="flex items-center gap-2 px-3 py-1.5 rounded-md transition-colors hover:bg-white/20"
            >
              ...
              <span class={`text-sm font-medium ${pathname === '/' ? 'text-[#006124]' : 'text-[#006124]'}`}>
                {_`Llamar`}
              </span>
            </a>
            <a
          ...
          <div class="flex items-center gap-6">
            ...
            <div class="flex items-center gap-4">
              <a
                ...
                class="text-[#CE2B37] hover:text-[#b52532] bg-white/90 h-8 w-8   rounded-full transition-colors hover:bg-white flex justify-center items-center"
              >
